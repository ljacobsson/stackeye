...
Lambda invocations and DynamoDB writes affect the deployed stack. DynamoDB updates require an explicit browser confirmation, are limited to tables discovered in the selected stack, and return the updated item. Scans and queries are capped at 250 items per request.
